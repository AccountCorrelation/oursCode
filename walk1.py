...
#START是主函数
def start(father,numpaths,filename='foursquare_following'):
    #father="data0/"
    #第一部分：获得图中边的字典表示
    xDict_out,xDict_in=loadGraphDict(father+'foursquare_following')
    #print "xDict=",xDict
    #yDict_out,yDict_in=loadGraphDict(father+'twitter_following')
    #print "yDict=",yDict
    while(numpaths!='stop'):
